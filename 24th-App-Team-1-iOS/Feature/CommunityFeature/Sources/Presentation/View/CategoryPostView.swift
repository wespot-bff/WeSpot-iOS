...
struct CategoryPostView: View {
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            .overlay(
                profileCircle()
                    .offset(x: 20, y: topInset + bannerHeight - circleRadius),
    ...
    private func headerView(topInset: CGFloat) -> some View {
        VStack(spacing: 0) {
            Rectangle()
                ...
                .overlay(
                    LinearGradient(
                        gradient: Gradient(colors: [Color.black.opacity(0.2), .clear]),
        ...
        .frame(height: topInset + bannerHeight + circleRadius + 20 + 28)
    ...
    private func profileCircle() -> some View {
        Circle()
            ...
            .frame(width: 56, height: circleDiameter)
